<template>
  ...
  <div class="api-container-detail">
      ...
      <p>Pustaka Kalender Jawa bisa dipakai dilingkungan Node maupun Browser</p>
      <h3 id="node">Node</h3>
      <div class="javascript hljs">
        <pre>
          <code><span class="hljs-selector-tag">npm</span> <span class="hljs-selector-tag">install</span> <span class="hljs-selector-tag">--save</span> @<span class="hljs-keyword">kalenderjawa</span>/<span class="hljs-keyword">pustaka</span></code>
        </pre>
      </div>
      ...
      <div class="html hljs">
        <pre>
          <code class="lang-html"><span class="hljs-tag">&lt;<span class="hljs-name">script</span> <span class="hljs-attr">src</span>=<span class="hljs-string">"https://unpkg.com/@kalenderjawa/pustaka"</span>/&gt;</span><span class="undefined"></span></code>
        </pre>
      </div>
    </div>
